...
def get_flops(model, imgsz=640, exact=False):
    ...
    try:
        ...
        try:
            ...
            # Match the dummy input dtype to the model.  This is required for
            # FP16 benchmark/training models; otherwise thop raises a dtype
            # mismatch before it can profile the network.
            im = torch.empty(

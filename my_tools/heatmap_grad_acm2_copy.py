...
class yolov8_heatmap:
    def __init__(self, weight, cfg, device, method, layer, backward_type, conf_threshold_max, conf_threshold_min, ratio):
...
if __name__ == '__main__':
    ...
    save_dir = r'/scrinvme/huilin/tp/FLIR1444_img_mayolo_grad_acm'
    # weight = r'/localnvme/project/ultralytics/runs/exp_results/exp_yolo10x/weights/best.pt'
    # save_dir = r'/scrinvme/huilin/tp/FLIR1444_img_yolo10_grad_acm'
    params = get_params()

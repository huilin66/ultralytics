...
def gap_select(img_dir, dst_dir, train_ratio=0.9, full_path=True):
    ...
    interval = len(file_list) // int((1-train_ratio)*100)  # ������

    val_list = file_list[::interval]  # ʹ����Ƭ����ȡ���ȼ����Ԫ��
    train_list = [item for i, item in enumerate(file_list) if i % interval != 0]  # ������Ԫ�ر��浽train_list

...
# DATA_SB1 = "fusedata7961_mseg_c5_l2_1117_v18_sb_test_broken.yaml"
DATA_SB2 = "fusedata7961_mseg_c5_l2_1117_v19_sb_test_broken_syn_v1.yaml"
...
if __name__ == '__main__':
    pass
    demo_base.yolo10(
        MODEL4_ST, weight_path=SEG_WEIGHT10, data=DATA_SB2, auto_optim=False, retrain=True,
    ...
    #     mloss_mask=False, mloss_weight=0, mloss_enlarge=1, contrastive_loss=True, name='debug'
    # )
    # demo_base.yolo10(
    #     MODEL4_S, weight_path=SEG_WEIGHT10, data=DATA_SB2, auto_optim=False, retrain=True,
    #     mloss_mask=False, mloss_weight=0, mloss_enlarge=20, contrastive_loss=True,
    # )
    # demo_base.yolo10(

...
if __name__ == '__main__':
    ...
    # model_val(r'runs/mdetect/exp_yolo8x/weights/best.pt')
    # model_val(r'runs/mdetect/exp_yolo8n/weights/best.pt')
    # model_val(r'runs/mdetect/exp_yolo8s/weights/best.pt')
    # model_val(r'runs/mdetect/exp_yolo8m/weights/best.pt')
    # model_val(r'runs/mdetect/exp_yolo8l/weights/best.pt')
    # model_val(r'runs/mdetect/exp_yolo8x/weights/best.pt')
    #
    # model_val(r'runs/mdetect/exp_yolo9s/weights/best.pt')
    # model_val(r'runs/mdetect/exp_yolo9m/weights/best.pt')
    # model_val(r'runs/mdetect/exp_yolo9c/weights/best.pt')
    # model_val(r'runs/mdetect/exp_yolo9e/weights/best.pt')
    #
    # model_val(r'runs/mdetect/exp_yolo10n/weights/best.pt')
    # model_val(r'runs/mdetect/exp_yolo10s/weights/best.pt')
    # model_val(r'runs/mdetect/exp_yolo10m/weights/best.pt')
    # model_val(r'runs/mdetect/exp_yolo10b/weights/best.pt')

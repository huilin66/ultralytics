...
各结构的 Test mAP50 和 Test mAP50-95 均与对应的 GIA 结果一致，差异仅体现在属性 F1。

| seed | GIA F1 | GCA F1 | GCN F1 | GAT F1 | GraphSAGE F1 | GIN F1 |
|---:|---:|---:|---:|---:|---:|---:|
| 0 | 0.656026 | 0.656026 | 0.656026 | 0.622564 | 0.656026 | 0.622564 |
| 1 | 0.642142 | 0.625886 | 0.627313 | 0.639914 | 0.627313 | **0.656561** |
| 2 | 0.593163 | 0.593873 | 0.572739 | 0.593873 | 0.593873 | 0.591257 |
| 3 | 0.573754 | 0.573754 | 0.573754 | 0.573754 | 0.573754 | **0.605533** |
| 4 | 0.588384 | 0.587070 | 0.588384 | 0.587070 | 0.586270 | **0.626165** |
...
| 方法 | F1_macro_test | 相对 GIA |
|---|---:|---:|
| GIA | 0.610694 ± 0.032291 | — |
| GCA | 0.607322 ± 0.029781 | -0.003372 |
| GCN | 0.603643 ± 0.032819 | -0.007051 |
| GAT | 0.603435 ± 0.024236 | -0.007259 |
| GraphSAGE | 0.607447 ± 0.030075 | -0.003247 |
| **GIN** | **0.620416 ± 0.021981** | **+0.009722** |
...
各结构的 Test mAP50 和 Test mAP50-95 在结构之间保持一致，差异主要体现在属性 F1。

| seed | Test mAP50 | Test mAP50-95 | GCA F1 | GCN F1 | GAT F1 | GraphSAGE F1 | GIN F1 |
|---:|---:|---:|---:|---:|---:|---:|---:|
| 0 | 0.689416 | 0.472100 | 0.656026 | 0.656026 | 0.656026 | 0.656026 | 0.642341 |
| 1 | 0.660033 | 0.472374 | 0.625886 | 0.627313 | 0.637846 | 0.627313 | **0.658225** |
| 2 | 0.590233 | 0.393701 | 0.593873 | 0.572739 | 0.593873 | 0.593873 | 0.594651 |
| 3 | 0.657648 | 0.467967 | 0.573754 | 0.573754 | **0.591678** | 0.573754 | 0.571834 |
| 4 | 0.602135 | 0.424329 | 0.587070 | 0.588384 | 0.588384 | 0.587070 | **0.627738** |

五个 seed 的 Cross F1 平均结果：
...
| GCA | 0.607322 ± 0.029781 | -0.003372 |
| GCN | 0.603643 ± 0.032819 | -0.007051 |
| **GAT** | **0.613561 ± 0.027905** | **+0.002868** |
| GraphSAGE | 0.607607 ± 0.029964 | -0.003087 |
| **GIN** | **0.618958 ± 0.031551** | **+0.008264** |
...
各结构的 Test mAP50 和 Test mAP50-95 均与对应 Baseline Stage2 一致，差异仅体现在属性 F1。

#### Conditional 矩阵

| seed | Baseline F1 | GCA F1 | GCN F1 | GAT F1 | GraphSAGE F1 | GIN F1 |
|---:|---:|---:|---:|---:|---:|---:|
| 0 | 0.645716 | 0.618513 | **0.645847** | 0.616151 | 0.618513 | 0.633257 |
| 1 | 0.624775 | 0.623764 | 0.625996 | 0.623764 | 0.624775 | **0.646595** |
| 2 | 0.646610 | 0.646610 | **0.648005** | **0.648005** | 0.626217 | 0.614920 |
...
|---|---:|---:|
| Baseline Stage2 | 0.618945 ± 0.043719 | — |
| GCA | 0.611466 ± 0.040299 | −0.007479 |
| **GCN** | **0.617658 ± 0.043580** | −0.001287 |
| GAT | 0.611564 ± 0.040664 | −0.007381 |
...
| seed | Baseline F1 | GCA F1 | GCN F1 | GAT F1 | GraphSAGE F1 | GIN F1 |
|---:|---:|---:|---:|---:|---:|---:|
| 0 | 0.645716 | 0.618513 | **0.645847** | 0.601624 | 0.620039 | 0.617948 |
| 1 | 0.624775 | 0.623764 | 0.625996 | 0.621633 | 0.624775 | **0.646682** |
| 2 | 0.646610 | 0.646610 | 0.648005 | 0.648005 | 0.646194 | **0.653143** |
...
| Baseline Stage2 | 0.618945 ± 0.043719 | — |
| GCA | 0.611466 ± 0.040299 | −0.007479 |
| **GCN** | **0.618562 ± 0.043855** | −0.000383 |
| GAT | 0.607940 ± 0.040414 | −0.011004 |

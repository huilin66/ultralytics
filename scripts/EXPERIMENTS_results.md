...
E2.28 在 E2.27 GIA-v2.5.7 五个 seed 的 Stage1 checkpoint 基础上，进行
Conditional 矩阵的 margin-residual 结构测试：GCA、GCN、GAT、GraphSAGE 和 GIN，
共 25 个 Stage2 实验。以下与对应 seed 的 E2.27 GIA-v2.5.7 Stage2 结果对齐。
...
Cross 矩阵结果待 GPU0 的 E2.28 批次完成后补充。

...
if __name__ == '__main__':
    ...
    #                 weight_path=r'runs/segment/fusedata2419_seg_c5_0730-[yolov8x-seg-dlka3res]4/weights/best.pt',
    #                 auto_optim=False,
    #                 retrain=True,
    #                 mloss_mask=False,
    #                 mloss_weight=False,
    #                 mloss_enlarge=2,
    #                 # name='debug'
    #                 data = "fusedata3044_mseg_c5_0731.yaml",
    #                 )
    # demo_base.yolo8('yolov8x-mseg-dlka3res-7.yaml',
    #                 weight_path=r'runs/segment/fusedata2419_seg_c5_0730-[yolov8x-seg-dlka3res]4/weights/best.pt',
    #                 auto_optim=False,
    ...
    #                 mloss_enlarge=2,
    #                 # name='debug'
    #                 data = "fusedata3044_mseg_c5_l2_0731.yaml",
    #                 )
    # demo_base.yolo8('yolov8x-mseg-dlka3res-7.yaml',
    #                 weight_path=r'runs/segment/fusedata2419_seg_c5_0730-[yolov8x-seg-dlka3res]4/weights/best.pt',
    #                 auto_optim=False,
    ...
    #                 # name='debug'
    #                 )
    # demo_base.model_val(r'runs/msegment/fusedata2177_mseg_c5_0718-[yolov8x-mseg-dlka3res-7]21/weights/best.pt',

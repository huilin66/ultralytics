...
if __name__ == '__main__':
    ...
    # demo_base.model_val('runs/classify/fusedata1361_cls_c6_check0618_riskA-[yolov8x-cls]3/weights/best.pt',
    #                     data='fusedata1361_cls_c6_check0618_riskA.yaml')
    # demo_base.model_val('runs/classify/fusedata1361_cls_c6_check0618_riskA-[yolov8x-cls]3/weights/best.pt',
    #                     data='fusedata1361_cls_c6_check0618_riskA_val208.yaml')
    # demo_base.model_val('runs/classify/fusedata1361_cls_c6_check0618_riskB-[yolov8x-cls]/weights/best.pt',
    #                     data='fusedata1361_cls_c6_check0618_riskB.yaml')
    # demo_base.model_val('runs/classify/fusedata1361_cls_c6_check0618_riskB-[yolov8x-cls]/weights/best.pt',
    #                     data='fusedata1361_cls_c6_check0618_riskB_val208.yaml')
    # demo_base.model_val('runs/classify/fusedata1361_cls_c6_check0618_riskC-[yolov8x-cls]/weights/best.pt',
    #                     data='fusedata1361_cls_c6_check0618_riskC.yaml')
    # demo_base.model_val('runs/classify/fusedata1361_cls_c6_check0618_riskC-[yolov8x-cls]/weights/best.pt',
    #                     data='fusedata1361_cls_c6_check0618_riskC_val208.yaml')
    demo_base.model_val('runs/classify/fusedata1361_cls_c6_check0618_riskD-[yolov8x-cls]/weights/best.pt',
                        data='fusedata1361_cls_c6_check0618_riskD.yaml')
    demo_base.model_val('runs/classify/fusedata1361_cls_c6_check0618_riskD-[yolov8x-cls]/weights/best.pt',
                        data='fusedata1361_cls_c6_check0618_riskD_val208.yaml')
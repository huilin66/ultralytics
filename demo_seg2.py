...
if __name__ == '__main__':
    pass
    # demo_base.yolo8('yolov8x-seg.yaml', auto_optim=False, data="fusedata1361_seg_c6_check0624.yaml")
    # demo_base.yolo8('yolov8x-seg-dlka3res.yaml', auto_optim=False, data="fusedata1361_seg_c6_check0624.yaml")


    # demo_base.model_val('runs/segment/fusedata1422_seg_c6_check0708-[yolov8x-seg]/weights/best.pt', save_json=True)
    demo_base.model_predict('runs/segment/fusedata1422_seg_c6_check0708-[yolov8x-seg]/weights/best.pt',
